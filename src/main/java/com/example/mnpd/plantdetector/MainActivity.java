...
public class MainActivity extends AppCompatActivity {
    ...
    public void colorVariation() {
        ...
        red.setText(String.format("%.2f", (rCount / allPixel) * 100));
        green.setText(String.format("%.2f", (gCount / allPixel) * 100));
        yellow.setText(String.format("%.2f", (yCount / allPixel) * 100));
